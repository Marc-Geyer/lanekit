...
STRINGS = {
    ...
    'btn_mark_unknown_absent':  'Unbekannte als abwesend markieren',
    'confirm_mark_unknown_absent': 'Alle mit unbekanntem Status als abwesend markieren?',
    ...
    'btn_choose_photo':         'Aus Galerie wählen',
    'btn_remove_photo':         'Foto entfernen',
    'confirm_remove_photo':     'Dieses Foto entfernen?',
    'photo_save_first':         'Eintrag zuerst speichern, um ein Foto hinzuzufügen.',
    ...
    'ws_polling':               'Offline – synchronisiere periodisch',
    'ws_error':                 'Fehler',
    'btn_reconnect':            'Erneut verbinden',
    'btn_edit':                 'Bearbeiten',
